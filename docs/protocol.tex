...
\begin{document}
    ...
    \hyperlink{section.4.3}{4.3}. ID generation MUST be rate limited to prevent ID exhaustion. Rate limiting rules
    are out of scope for this protocol, however some suggestions are listed \hyperlink{section.4.4}{4.4}.
    ...
    If \emph{has-cookie} is 1, a Server MAY consider the \emph{cookie} value in \emph{LeaseRequest} or completly
    ignore it.
    ...
    \emph{expiration} is a 64 bit Unix timestamp representing the expiry of lease. Disconnection of a client (e.g, the TCP connection is dropped) does not end a lease\\
    ...
    \begin{itemize}
        ...
        \item % // TODO define more restrictions %
