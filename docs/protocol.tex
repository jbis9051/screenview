...
\begin{document}
    ...
    To begin and client connections to the server over TCP and commences the Server Encryption Layer protocol for TCP
    ...
    The SVSC protocol is used to interact with the relay server, Server. This includes things like leasing an ID as
    well as initializing a connection to Host.
    ...
    the verison supported by the Host.\\
