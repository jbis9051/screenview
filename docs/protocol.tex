...
\begin{document}
    ...
    The Server Encryption layer provides security between the Server and other parties (Client and Host). The Server Encryption Layer is discussed in % TODO insert secition number
    .

    \subsection{Initialization}

    To begin and client connections to the server over TCP and commences the Server Encryption Layer protocol for TCP defined in % TODO insert section number
