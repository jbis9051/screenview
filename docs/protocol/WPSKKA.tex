...
WPSKKA begins with a handshake to choose an authentication scheme.
The goal of WPSKKA is to authenticate the Peers' ephemeral keys.
...
SRP is a PAKE and therefore relies on a password.
