...
With the exception of the \hyperref{subsection.4.2}{Handshake} messages. All SVSC messages' first byte contain a
number to indicate
the message type.
...
Handshaking begins by the Server sending the Peer a ProtocolVersion message. This lets the server know
